...
if(isset($_POST['registrarmee'])){
  ?>
   <div class="alert alert-info small alert-dismissible">
    ...
    <strong>Info!</strong> Por favor Iniciar sesion para poder continuar :D
  </div>
<?php
}
...
<div>
           ...
           <div class="logo mb-3">
             <div class="col-md-12 text-center">
              <img src="img/lacompra.png" style="width:70px; height: 70px; ">
              <h4 style="color: #007bff; font-family: 'Roboto Slab', serif; text-decoration-line:underline ;">La Compra</h4>
             </div>
          </div>
...
?>
                           ...
                           <div class="form-group">
                              <p class="text-center">¿No tienes cuenta? <a href="#" id="signup"><strong>REGISTRARME</strong></a></p>
                                <a href="olvide.php"><p class="text-center" style="font-size: 14px;">¿Olvidaste tu contraseña?</p></a>
                           </div>
                        </form>
