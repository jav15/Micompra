...
<a class="navbar-brand" href="index.php">
    <img src="img/lacompra.png" alt="Lacompra" style="width:40px; height: 40px;"> <span style="font-family: 'Roboto Slab', serif; color: #fff; text-decoration-line:underline ;  ">La compra</span>
  </a>
